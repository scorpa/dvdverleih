...
public class RentDVD extends JDialog {
	...
	private void setWindow() {
		...
		fistPanel.setBorder(new TitledBorder(UIManager
				.getBorder("TitledBorder.border"),
				"Bitte waehlen Sie einen Kunden aus", TitledBorder.LEADING,
		...
		gl_fistPanel.setHorizontalGroup(gl_fistPanel
				...
				.addGroup(
						gl_fistPanel
								...
								.addComponent(txtFilterCustomer,
										GroupLayout.DEFAULT_SIZE, 386,
										Short.MAX_VALUE))
				.addComponent(panel_1, GroupLayout.DEFAULT_SIZE, 424,
						Short.MAX_VALUE));
		gl_fistPanel
				.setVerticalGroup(gl_fistPanel
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_fistPanel
										.createSequentialGroup()
		...
		secondPanel.setBorder(new TitledBorder(null,
				"Bitte waehlen Sie eine DVD aus", TitledBorder.LEADING,
				TitledBorder.TOP, null, null));
		...
		gl_secondPanel.setHorizontalGroup(gl_secondPanel
				.createParallelGroup(Alignment.LEADING)
				.addGroup(
						gl_secondPanel
								.createSequentialGroup()
								...
								.addComponent(label)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(txtFilterDVD,
										GroupLayout.DEFAULT_SIZE, 390,
										Short.MAX_VALUE).addContainerGap())
				.addComponent(panel, GroupLayout.DEFAULT_SIZE, 440,
						Short.MAX_VALUE));
		gl_secondPanel
				.setVerticalGroup(gl_secondPanel
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_secondPanel
										.createSequentialGroup()
		...
		thirdPanel.setBorder(new TitledBorder(null, "Zusammenfassung",
		...
		gl_thirdPanel.setHorizontalGroup(gl_thirdPanel.createParallelGroup(
		...
		gl_thirdPanel.setVerticalGroup(gl_thirdPanel.createParallelGroup(
				Alignment.LEADING).addGroup(
				gl_thirdPanel.createSequentialGroup().addComponent(lblCustomer)
